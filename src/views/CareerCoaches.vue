...
const valuePoints = [
  {
    icon: 'shield-halved',
    title: 'Sponsorship data you can\'t Google',
    body: "Every match is checked against real H-1B and PERM filing history — data your practice would otherwise have to piece together one employer at a time.",
  },
  {
    icon: 'file-lines',
    title: 'A second set of eyes on every resume',
    body: "Job-Hopper's resume advice flags gaps before a real recruiter ever sees the resume — a backstop for your own coaching, not a replacement for it.",
  },
  {
    icon: 'graduation-cap',
    title: 'Built-in interview prep',
    body: 'AI-powered mock interviews and a skill-gap breakdown your clients can use between sessions, so your coaching time goes further.',
  },
]
</script>
    ...
    <div class="max-w-6xl mx-auto">
      ...
      <section class="mb-16 text-center">
        <p class="text-sm font-semibold uppercase tracking-wide text-brand-primary mb-3">
          For career coaches &amp; resume businesses
        </p>
        <h1 class="text-brand-charcoal mb-6">
          Give your clients sponsorship data you can't Google.
        </h1>
        <p class="text-xl text-neutral-body max-w-3xl mx-auto">
          Job-Hopper matches visa-seeking clients to employers verified against real DOL
          and USCIS filing history, plus resume advice and interview prep to back up
          your own coaching.
        </p>
      </section>
      ...
      <!-- Partner trial framing -->
      <section class="mb-16 text-center">
        <h2 class="font-heading font-semibold text-brand-charcoal text-2xl mb-3">
          Try it with your own clients first
        </h2>
        <p class="text-neutral-body max-w-2xl mx-auto">
          Tell us about your practice below and we'll set up a trial so you can see the
          match quality yourself before recommending it.
        </p>
      </section>
          ...
          <div class="flex items-start">
            ...
            <div>
              ...
              <p class="text-green-800">
                Someone from our team will follow up to set up your trial shortly.
              </p>
            </div>
          </div>
        </div>
        ...
        <form v-else @submit.prevent="handleSubmit" class="card p-8 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              required
              class="input"
              placeholder="e.g. Example Career Coaching"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              required
              class="input"
              placeholder="e.g. Founder, Career Coach"
            />
          </div>
          ...
          <button type="submit" :disabled="isSubmitting" class="btn-primary w-full">
            ...
            <span v-else>Start partner trial</span>
          </button>
        </form>
      </section>
    </div>
