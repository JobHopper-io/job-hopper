...
const valuePoints = [
  {
    ...
    body: "Every match is checked against real H-1B and PERM filing history, not a guessed 'sponsors visas' tag — so 'does this company actually sponsor?' has a real answer before a student applies.",
  },
  {
    icon: 'globe-americas',
    title: 'Built for the clock students are on',
    body: "OPT, CPT, and H-1B cap season aren't an afterthought for the students you support — Job-Hopper is about getting a fast, real answer, not padding a maybe-list they don't have time for.",
  },
  {
    icon: 'graduation-cap',
    ...
    <div class="max-w-6xl mx-auto">
      ...
      <section class="mb-16 text-center">
        <p class="text-sm font-semibold uppercase tracking-wide text-brand-primary mb-3">
          For international student &amp; ISSS offices
        </p>
        <h1 class="text-brand-charcoal mb-6">
          Give every international student a real answer on sponsorship — before they apply.
        </h1>
        <p class="text-xl text-neutral-body max-w-3xl mx-auto">
          Job-Hopper matches your students to employers verified against real DOL and
          USCIS filing data, so "does this company sponsor?" stops being a guess.
        </p>
      </section>
      ...
      <section class="mb-16 text-center">
        <h2 class="font-heading font-semibold text-brand-charcoal text-2xl mb-3">
          A demo built around your program
        </h2>
        <p class="text-neutral-body max-w-2xl mx-auto">
          Tell us about your office below and we'll walk through what this looks like for
          your students specifically — no generic sales deck.
        </p>
      </section>
      ...
      <section class="max-w-xl mx-auto">
          ...
          <div class="flex items-start">
            ...
            <div>
              ...
              <p class="text-green-800">
                Someone from our team will follow up to schedule a demo shortly.
              </p>
            </div>
          </div>
        </div>
        ...
        <form v-else @submit.prevent="handleSubmit" class="card p-8 space-y-6">
          ...
          <button type="submit" :disabled="isSubmitting" class="btn-primary w-full">
            ...
            <span v-else>Request program demo</span>
          </button>
        </form>
      </section>
    </div>
